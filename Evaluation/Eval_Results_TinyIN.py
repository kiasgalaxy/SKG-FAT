...
import argparse
import logging
from models_TinyIN.resnet import ResNet18
import tqdm
...
def get_args():
    ...
    parser.add_argument('--data-dir', type=str, default='/home/jiangchengze/Dataset')
...
train_loader, test_loader = get_loaders_TinyIN(args.data_dir, args.batch_size)
